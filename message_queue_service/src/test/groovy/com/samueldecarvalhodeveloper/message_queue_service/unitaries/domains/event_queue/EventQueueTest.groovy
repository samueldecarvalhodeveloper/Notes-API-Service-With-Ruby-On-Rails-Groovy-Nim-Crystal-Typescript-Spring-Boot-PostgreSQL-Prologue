package com.samueldecarvalhodeveloper.message_queue_service.unitaries.domains.event_queue
...
import static com.samueldecarvalhodeveloper.message_queue_service.constants.domains.EventQueueConstants.QUEUE_OF_EVENTS_CLASS_ATTRIBUTE
import static org.assertj.core.api.Assertions.assertThat

@SpringBootTest
class EventQueueTest {
    @Test
    void testIfMethodAddEventAddsEventToQueue() {
    ...
    @Test
    void testIfMethodProcessQueueExecuteAllOnlineAddedEvents() {
        Integer numberToBeChanged = Integer.MIN_VALUE
