...
class HttpClientComponentTest {
    ...
    @Test
    void testMakingGetAHttpRequestAndReturnsItsSerializedJsonResponse() {
    ...
    @Test
    void testMakingPostHttpRequestAndReturnsItsStatusCode() {
    ...
    @Test
    void testMakingPatchHttpRequestAndReturnsItsStatusCode() {
    ...
    @Test
    void testMakingDeleteHttpRequestAndReturnsItsStatusCode() {
        UserEntity user = new UserEntity(USER_ID, USER_USERNAME)
