...
describe("Test Class UserRepository Behavior", () => {
  ...
  test('Test If Method "getUsers" Returns All Users From In-Memory Database', async () => {
  ...
  test('Test If Method "getUser" Returns User From In-Memory Database', async () => {
    const user = UserEntityFactory.getInstance(USER_ID, USER_USERNAME);
