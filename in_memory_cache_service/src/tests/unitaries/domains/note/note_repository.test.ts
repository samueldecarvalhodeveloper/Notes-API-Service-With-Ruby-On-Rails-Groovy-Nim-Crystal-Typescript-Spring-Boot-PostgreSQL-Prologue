...
describe("Test Class NoteRepository Behavior", () => {
  ...
  test('Test If Method "getNotes" Returns All Users\'s Notes', async () => {
  ...
  test('Test If Method "getNote" Returns Users\'s Note', async () => {
    const note = NoteEntityFactory.getInstance(
      NOTE_ID,
      NOTE_TITLE,
      NOTE_BODY,
  ...
  test('Test If Method "deleteNote" Delete Note On Database', async () => {
    const note = NoteEntityFactory.getInstance(
      NOTE_ID,
      NOTE_TITLE,
      NOTE_BODY,
