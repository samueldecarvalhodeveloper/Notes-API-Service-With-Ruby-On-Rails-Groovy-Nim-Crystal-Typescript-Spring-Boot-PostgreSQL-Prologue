...
class NoteUseCasesTest < ActiveSupport::TestCase
  test "Test If Method \"get_note\" Returns Note From Database" do
  ...
  test "Test If Method \"get_all_notes\" Returns All Notes From Database" do
    User.create id: UserConstants::USER_TO_BE_CREATED_ID, username: UserConstants::USER_TO_BE_CREATED_USERNAME
  ...
  test "Test If Method \"create_note\" Creates Note On Database" do
    User.create id: UserConstants::USER_TO_BE_CREATED_ID, username: UserConstants::USER_TO_BE_CREATED_USERNAME
  ...
  test "Test If Method \"update_note\" Updates Note On Database" do
    User.create id: UserConstants::USER_TO_BE_CREATED_ID, username: UserConstants::USER_TO_BE_CREATED_USERNAME
  ...
  test "Test If Method \"delete_note\" Deletes Note On Database" do
    User.create id: UserConstants::USER_TO_BE_CREATED_ID, username: UserConstants::USER_TO_BE_CREATED_USERNAME
    ...
    assert_raises ActiveRecord::RecordNotFound do
      Note.find NoteConstants::NOTE_TO_BE_CREATED_ID
    end
  end
end
