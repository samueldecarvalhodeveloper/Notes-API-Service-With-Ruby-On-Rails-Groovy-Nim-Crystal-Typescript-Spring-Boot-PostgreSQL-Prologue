...
suite "Test Component \"Server\" Behavior":
  ...
  test "Test Responding To Client All Users":
    let requestResponse =
  ...
  test "Test Responding To Client User":
  ...
  test "Test Creating User":
    ...
    check(user[0].username == USER_USERNAME)
  ...
  test "Test Responding To Client All User Notes":
    createUser(USER_OBJECT)
  ...
  test "Test Responding To Client Note":
    createUser(USER_OBJECT)
